...
const Contact = () => {
  return (
    <div name='contact' className='w-full h-screen bg-darkteal flex justify-center items-center px-16 pt-4'>
        <form action='https://formsubmit.co/51abf543d0165418ae9937a40781945e' method='POST' className='flex flex-col max-w-[1000px] w-full'>
            <div className='pb-8'>
            ...
            <button className='text-lg text-yellow rounded-lg border-2 hover:bg-yellow hover:text-darkteal duration-300 px-6 py-4 my-2 mx-auto flex items-center' type='submit'>Let's Collaborate</button>
        </form>
