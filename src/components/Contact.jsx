  ...
  return (
    <div name='contact' className='w-full h-screen bg-darkteal flex justify-center items-center px-16'>
        <form className='flex flex-col max-w-[1000px] w-full'>
            ...
            <button className='text-lightgray text-lg border-2 hover:bg-yellow hover:border-yellow hover:text-darkteal duration-300 px-6 py-3 my-2 mx-auto flex items-center rounded-sm'>Let's Collaborate</button>
        </form>
